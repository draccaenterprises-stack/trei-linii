...
export const Route = createFileRoute("/collections")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Three lines, one language. Essentials, Washed, and Graphics." },
    ],
  }),
});
    ...
    <div className="px-5 md:px-10 py-12 md:py-20">
      <div className="mx-auto max-w-[1600px]">
        <header className="mb-12 md:mb-20 max-w-3xl">
          ...
          <h1 className="font-display text-5xl md:text-8xl mt-2">Three lines.<br />One language.</h1>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {collections.map((c) => <CollectionCard key={c.handle} collection={c} />)}
        </div>
      </div>
    </div>
  );
