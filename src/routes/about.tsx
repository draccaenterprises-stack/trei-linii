...
export const Route = createFileRoute("/about")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "BLANK ATELIER is a Bucharest-based studio building quiet, heavyweight uniforms for everyday life." },
    ],
  }),
});
    ...
    <div className="px-5 md:px-10 py-12 md:py-20">
      <div className="mx-auto max-w-[1100px]">
        ...
        <h1 className="font-display text-5xl md:text-8xl mt-2 leading-[0.95]">
          We make heavy<br />cotton for quiet<br />people.
        </h1>
        ...
        <div className="mt-16 grid md:grid-cols-12 gap-12">
          <div className="md:col-span-7 space-y-6 text-lg leading-relaxed text-muted-foreground">
            <p>
              BLANK ATELIER is a small studio in Bucharest. We design and produce one thing very well —
              oversized cotton tees — and we drop them in small, dated runs.
            </p>
            <p>
              Every piece is knitted in Portugal at a mill we've worked with since 2024.
              240 gsm long-staple cotton, garment-dyed where it makes sense, finished with restraint.
              Small mark on the front. The story sits on the back.
            </p>
            <p>
              We don't do seasons. We do volumes. This is Volume I.
            </p>
          </div>
        ...
        <div className="mt-24 border-t border-border pt-8 flex items-center justify-between">
          ...
          <Link to="/shop" className="bg-charcoal text-cream px-6 py-3 font-mono-xs">Shop now →</Link>
        </div>
      </div>
    </div>
  );
